...
public class JobMapper {
	public static Job toEntity(JobDTO dto){
        Job entity = new Job(dto.getName(), dto.getSalary(), dto.getDescription(), dto.getCandidates());
        return entity;
    }

    public static JobDTO toDTO(Job entity){
    	JobDTO dto = new JobDTO(entity.getName(), entity.getSalary(), entity.getDescription(), entity.getCandidates());
        return dto;
    }
}
